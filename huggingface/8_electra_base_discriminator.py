...
with profile(on_trace_ready=torch.profiler.tensorboard_trace_handler('./log/electra_base_8'),profile_memory=True,with_stack=True,record_shapes=True) as prof: #for tensorboard
    with record_function("model_inference"):
        fake_sentence = "The quick brown fox fake over lazy dog "  #길이 128로 맞추기. (need to check if this is all inputted.) + if padded.
        test_model = electra()
