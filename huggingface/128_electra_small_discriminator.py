...
with profile(on_trace_ready=torch.profiler.tensorboard_trace_handler('./log/electra_small'),profile_memory=True,with_stack=True,record_shapes=True) as prof: #for tensorboard
