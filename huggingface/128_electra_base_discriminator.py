...
class electra(nn.Module):
    def __init__(self):
        ...
        self.tokenizer = ElectraTokenizerFast.from_pretrained("google/electra-base-discriminator") #identical to Bert tokenizer fake_sentence
...
with profile(on_trace_ready=torch.profiler.tensorboard_trace_handler('./log/electra_base'),profile_memory=True,with_stack=True,record_shapes=True) as prof: #for tensorboard
    with record_function("model_inference"):
        ...
        test_model = electra() # 이떄 line 11의 init called & forward also called. 
