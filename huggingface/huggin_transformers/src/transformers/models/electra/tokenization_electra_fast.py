...
PRETRAINED_VOCAB_FILES_MAP = { #predefined vocab input-URL set.
    "vocab_file": {
...
class ElectraTokenizerFast(BertTokenizerFast): #raw string treats backlash as a literal.
    r"""
    ...
    max_model_input_sizes = PRETRAINED_POSITIONAL_EMBEDDINGS_SIZES #mmax input size is determined.
    pretrained_init_configuration = PRETRAINED_INIT_CONFIGURATION
    slow_tokenizer_class = ElectraTokenizer #이렇게 연결되지만, 정확히 어디서 쓰이는지는 모르겠다. 
