...
#electra trace file에 thread 갯수도 넣어주기.
with profile(on_trace_ready=torch.profiler.tensorboard_trace_handler('./log/electra_22'),profile_memory=True,with_stack=True,record_shapes=True) as prof: #for tensorboard
